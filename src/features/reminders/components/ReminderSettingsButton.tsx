        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-1">
            <label className="flex cursor-pointer items-center gap-2 text-[13px] font-bold text-zinc-400">
              <input type="checkbox" disabled className="rounded border-zinc-300 dark:border-[var(--line)]" />
              {t("auto_send")}
            </label>
          ...
          <div className="mt-4 flex justify-end gap-3">
            <button
              ...
              className="rounded-xl px-5 py-2.5 text-[13px] font-bold text-zinc-700 hover:bg-zinc-100 dark:text-zinc-300 dark:hover:bg-[var(--line)] transition-colors"
            >
              {t("cancel")}
            </button>
            <button
